 ...
 * @internal
 */
export function createMotionComponent(Component: string) {
    function MotionComponent(props: MotionProps, _externalRef?: Ref<Element>) {
        const { render } = useContext(MotionSetupContext)
        ...
        return render(Component, props, true)
    }
